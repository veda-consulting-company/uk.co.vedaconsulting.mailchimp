...
class CRM_Mailchimp_Form_Sync extends CRM_Core_Form {
  ...
  public static function getRunner($skipEndUrl = FALSE, $dry_run = FALSE) {
    ...
    foreach ($groups as $group_id => $details) {
      ...
      $task  = new CRM_Queue_Task(
        ...
        [$details['api_key'], $details['list_id'], $identifier, $dry_run],
   ...
   */
  public static function syncPushList(CRM_Queue_TaskContext $ctx, $apiKey, $listID, $identifier, $dry_run) {
   ...
   */
  public static function syncPushCollectCiviCRM(CRM_Queue_TaskContext $ctx, $apiKey, $listID) {
    CRM_Mailchimp_Utils::checkDebug('Start-CRM_Mailchimp_Form_Sync syncPushCollectCiviCRM $listID= ', $listID);

    $sync = new CRM_Mailchimp_Sync($apiKey, $listID);
   ...
   */
  public static function syncPushCollectMailchimp(CRM_Queue_TaskContext $ctx, $apiKey, $listID) {
   ...
   */
  public static function syncPushDifficultMatches(CRM_Queue_TaskContext $ctx, $apiKey, $listID) {
   ...
   * Collect Mailchimp data into temporary working table.
   */
  public static function syncPushIgnoreInSync(CRM_Queue_TaskContext $ctx, $apiKey, $listID) {
   ...
   */
  public static function syncPushToMailchimp(CRM_Queue_TaskContext $ctx, $apiKey, $listID, $dry_run) {
